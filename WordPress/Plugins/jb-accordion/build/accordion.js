...
const Accordion = () => {
  ...
  const accordionToggles = document.querySelectorAll(".jb-accordion__toggle"); //grab all accordion content

  const accordionContents = document.querySelectorAll(".jb-accordion__content"); //mobile check
  ...
  const switchAccordion = e => {
    ...
    console.log("thisTrigger", thisTrigger); //if caputring event within button text buubble up to parent.
